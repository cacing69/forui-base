...
final List<Dependency> generalDependenciesStatic = [
  ...
  Dependency(
    icon: FIcons.codesandbox,
    name: "gap",
    url: "https://github.com/letsar/gap",
  ),
  Dependency(
    icon: FIcons.codesandbox,
  ...
  Dependency(
    icon: FIcons.codesandbox,
    name: "latlong2",
    url: "https://github.com/jifalops/dart-latlong",
  ),
  Dependency(
    icon: FIcons.codesandbox,
    name: "forui_hooks",
    url: "https://pub.dev/packages/forui_hooks",
  ),
  Dependency(
    icon: FIcons.codesandbox,
    name: "flutter_map",
...
final List<Dependency> developmentDependenciesStatic = [
  ...
  Dependency(
    ...
    url: 'https://pub.dev/packages/pretty_dio_logger',
  ),
  Dependency(
    icon: FIcons.bugPlay,
