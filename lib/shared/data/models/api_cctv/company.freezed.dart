...
mixin _$Company {
 ...
 List<CompanyChecklist>? get checklists; String? get employmentReportingNumber; List<CompanyProject>? get projects; String? get validationDate; List<CompanyPic>? get pic; String? get importFlag;@BigIntConverter() BigInt? get totalCapitalAmount; int? get domesticCapitalPercentage; String? get id; String? get issueDate; String? get email; String? get address; String? get legalBodyStatus; List<CompanyShareholder>? get shareholders; String? get bussinessActorType;@BigIntConverter() BigInt? get baseCapitalTotal; String? get taxNumber; List<CompanyLegality>? get legalities; String? get submissionDate; String? get approvalNumber;@BigIntConverter() BigInt? get domesticCapitalAmount; String? get exportFlag; String? get phoneNumber; int? get foreignCapitalPercentage;@BigIntConverter() BigInt? get registrationNumber; String? get businessScale;@BigIntConverter() BigInt? get foreignCapitalAmount; String? get name;@BigIntConverter() BigInt? get issueCapitalTotal; String? get companyTypeId; String? get onlineSingleSubmissionNumber; String? get villageId;
...
@useResult
$Res call({
 List<CompanyChecklist>? checklists, String? employmentReportingNumber, List<CompanyProject>? projects, String? validationDate, List<CompanyPic>? pic, String? importFlag,@BigIntConverter() BigInt? totalCapitalAmount, int? domesticCapitalPercentage, String? id, String? issueDate, String? email, String? address, String? legalBodyStatus, List<CompanyShareholder>? shareholders, String? bussinessActorType,@BigIntConverter() BigInt? baseCapitalTotal, String? taxNumber, List<CompanyLegality>? legalities, String? submissionDate, String? approvalNumber,@BigIntConverter() BigInt? domesticCapitalAmount, String? exportFlag, String? phoneNumber, int? foreignCapitalPercentage,@BigIntConverter() BigInt? registrationNumber, String? businessScale,@BigIntConverter() BigInt? foreignCapitalAmount, String? name,@BigIntConverter() BigInt? issueCapitalTotal, String? companyTypeId, String? onlineSingleSubmissionNumber, String? villageId
});
...
as BigInt?,exportFlag: freezed == exportFlag ? _self.exportFlag : exportFlag // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<CompanyChecklist>? checklists,  String? employmentReportingNumber,  List<CompanyProject>? projects,  String? validationDate,  List<CompanyPic>? pic,  String? importFlag, @BigIntConverter()  BigInt? totalCapitalAmount,  int? domesticCapitalPercentage,  String? id,  String? issueDate,  String? email,  String? address,  String? legalBodyStatus,  List<CompanyShareholder>? shareholders,  String? bussinessActorType, @BigIntConverter()  BigInt? baseCapitalTotal,  String? taxNumber,  List<CompanyLegality>? legalities,  String? submissionDate,  String? approvalNumber, @BigIntConverter()  BigInt? domesticCapitalAmount,  String? exportFlag,  String? phoneNumber,  int? foreignCapitalPercentage, @BigIntConverter()  BigInt? registrationNumber,  String? businessScale, @BigIntConverter()  BigInt? foreignCapitalAmount,  String? name, @BigIntConverter()  BigInt? issueCapitalTotal,  String? companyTypeId,  String? onlineSingleSubmissionNumber,  String? villageId)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Company() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<CompanyChecklist>? checklists,  String? employmentReportingNumber,  List<CompanyProject>? projects,  String? validationDate,  List<CompanyPic>? pic,  String? importFlag, @BigIntConverter()  BigInt? totalCapitalAmount,  int? domesticCapitalPercentage,  String? id,  String? issueDate,  String? email,  String? address,  String? legalBodyStatus,  List<CompanyShareholder>? shareholders,  String? bussinessActorType, @BigIntConverter()  BigInt? baseCapitalTotal,  String? taxNumber,  List<CompanyLegality>? legalities,  String? submissionDate,  String? approvalNumber, @BigIntConverter()  BigInt? domesticCapitalAmount,  String? exportFlag,  String? phoneNumber,  int? foreignCapitalPercentage, @BigIntConverter()  BigInt? registrationNumber,  String? businessScale, @BigIntConverter()  BigInt? foreignCapitalAmount,  String? name, @BigIntConverter()  BigInt? issueCapitalTotal,  String? companyTypeId,  String? onlineSingleSubmissionNumber,  String? villageId)  $default,) {final _that = this;
switch (_that) {
case _Company():
return $default(_that.checklists,_that.employmentReportingNumber,_that.projects,_that.validationDate,_that.pic,_that.importFlag,_that.totalCapitalAmount,_that.domesticCapitalPercentage,_that.id,_that.issueDate,_that.email,_that.address,_that.legalBodyStatus,_that.shareholders,_that.bussinessActorType,_that.baseCapitalTotal,_that.taxNumber,_that.legalities,_that.submissionDate,_that.approvalNumber,_that.domesticCapitalAmount,_that.exportFlag,_that.phoneNumber,_that.foreignCapitalPercentage,_that.registrationNumber,_that.businessScale,_that.foreignCapitalAmount,_that.name,_that.issueCapitalTotal,_that.companyTypeId,_that.onlineSingleSubmissionNumber,_that.villageId);case _:
  throw StateError('Unexpected subclass');
...
@override@JsonKey()@BigIntConverter() final  BigInt? domesticCapitalAmount;
...
@override@JsonKey()@BigIntConverter() final  BigInt? foreignCapitalAmount;
